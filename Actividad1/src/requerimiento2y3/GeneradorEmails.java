...
public class GeneradorEmails {
	...
	public String generarAsunto() {
		...
		listaAsuntos.add("Policia nacional infraccion");
		listaAsuntos.add("ahora por realizar una compra en tienda se llevara un 20% en nuestra llantas");
		listaAsuntos.add("en el parque de atraccion invitamos a su acompañante para que disfruteis de una noche epica!!");
		listaAsuntos.add("en reformatucasa le ofrecemos los mejores precios para reformar su casa");
		listaAsuntos.add("ahora con su tarjeta mastercard entrara en un sorteo para este fabuloso viaje");
		listaAsuntos.add("Su apuesta de bet365 a sido detreminada con un importe de 34.76€");
		listaAsuntos.add("Su informe del banco bbva a siod actualizado");
		listaAsuntos.add("introduzca sus datos personales en este formulacion y nosotros nos encargamos de todo");
		listaAsuntos.add("su cuenta para comegusanos a sido creada pinvhe aqui para meterse en nuestra web");
		listaAsuntos.add("El mejor momento es estar a nuestro lado por eso queremos compensarle con 20€ de descuento");
		listaAsuntos.add("Entradas compradas para el concierto de myke towers");
		listaAsuntos.add("En el Día de San Valentín, usted merece un buen regalo");
		listaAsuntos.add("quiere usted cambiar su telefono movil, contactenos");
		listaAsuntos.add("ya tiene su bonus descuento para apuesta de 5€");
		listaAsuntos.add("es usted de madrid y aun no lo conoce ven con nostros a disfrutarlo!!!");
		listaAsuntos.add("Su tienda de boutique para el automvil se translada a calle ferran barreiros 11");
		listaAsuntos.add("corra y ahorre con nosotros en nuestros supermecados Lidl");
		listaAsuntos.add("no esta contento con su tarifa plana de movil llamenos al 678787860");
		listaAsuntos.add("la suerte le quiere sonreir eche hoy su bonoloto y gane un bote de 1.000.000€");
		listaAsuntos.add("te tenta el chocolate nosotros tenemos los mejores");
		listaAsuntos.add("24 horas para finalidad su inscripcion");
		listaAsuntos.add("compra realizada a amazon");
		listaAsuntos.add("compra realizada a mercadona");
		listaAsuntos.add("quiere usted cenar gratis hoy jueves 2X1 en cenas");
		listaAsuntos.add("harto de oler mal consiga nuestro desodorantpor menos de lo que piensas" );
		listaAsuntos.add("su local de confianza para realizar sus eventos");
		listaAsuntos.add("ya llego el pescado mas fresco del mar cantabrico a su pescaderia");
		listaAsuntos.add("el mejor regalo para su pareja lo encontrara en nuestra web");
		listaAsuntos.add("Su silencioso akrapovik por el modico precio de 299.99€");
		listaAsuntos.add("se quiere levantar todos los dia con una sonrisa pues acuda a nuestros concesionarios bmw y llevate un coche");
	...
	public String generarCuerpoMensaje() {
		...
		listaMensajes.add("Usted a sido sancionado por mala actitud");
		listaMensajes.add("sus mejores llantas al 20% de descuento");
		listaMensajes.add("vive un halloween de locura");
		listaMensajes.add("Si no reformas tu casa es porque no quieres, nosotros le facilitamos todo");
		listaMensajes.add("Regalamos un viaje para dos personas con todo incluido a las maldivas");
		listaMensajes.add("bet365");
		listaMensajes.add("su banco bbva le notifica");
		listaMensajes.add("Consiga ya su oferta en quieromioferta.com");
		listaMensajes.add("su cuenta para comegusanos");
		listaMensajes.add("vivefeliz.com");
		listaMensajes.add("compratusentradas.com");
		listaMensajes.add("san valentin viene ya");
		listaMensajes.add("orange");
		listaMensajes.add("Sportium");
		listaMensajes.add("conoce tu madrid");
		listaMensajes.add("nos transladamos");
		listaMensajes.add("Lidl");
		listaMensajes.add("yoigo");
		listaMensajes.add("Bonoloto te espera");
		listaMensajes.add("chocolateria loles");
		listaMensajes.add("finalizar inscripcion");
		listaMensajes.add("Amazon");
		listaMensajes.add("Mercadona");
		listaMensajes.add("tu restaurante Ribs");
		listaMensajes.add("Axe" );
		listaMensajes.add("el paraiso tu local de celebraciones");
		listaMensajes.add("pescaderia paco");
		listaMensajes.add("regalasonrisas.com");
		listaMensajes.add("Mtuning performace");
		listaMensajes.add("Concesionarios BMW");
